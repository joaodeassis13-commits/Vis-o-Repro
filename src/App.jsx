  ...
  return (
    <div style={{ marginBottom: 22 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <div style={{ width: 34, height: 34, borderRadius: 8, background: "#EFE8D6", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
  ...
  return (
    <button
      ...
      style={{
        ...
        background: disabled ? "#C7B9A0" : "#B9541E", color: "#FFF6E9",
      ...
      {selecionados.length > 0 && (
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
          {selecionados.map((s) => {
            ...
            return (
              <span key={s.medicamentoId} style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "#EFE8D6", border: "1px solid #DCD2B3", borderRadius: 20, padding: "4px 10px", fontSize: 12.5 }}>
            ...
            return (
              <button key={n.key} onClick={() => setSection(n.key)}
                style={{
                  ...
                  background: active ? "#3B5D45" : "transparent", color: active ? "#F5EFDD" : "#C9CBB9",
            ...
            <>
              <div style={{ marginBottom: 10 }}>
                ...
                <select
                  ...
                  style={{
                    width: "100%", background: "#3B5D45", color: "#F5EFDD", border: "1px solid #4C6E56",
              ...
              return (
                <button key={t.key} onClick={() => setSub(t.key)}
                  style={{
                    ...
                    border: "none", borderBottom: active ? "2px solid #B9541E" : "2px solid transparent",
                    background: "transparent", color: active ? "#B9541E" : "#6B685E",
                    fontSize: 13, fontWeight: 600, cursor: "pointer", marginBottom: -1,
                  }}>
                  <Icon size={14} />
                  {t.label}
                  {pendentesSubtab > 0 && (
                    <span style={{ background: "#B9541E", color: "#FFF6E9", fontSize: 10.5, fontWeight: 700, borderRadius: 20, padding: "1px 7px" }}>{pendentesSubtab}</span>
                  )}
                </button>
              );
            })}
          ...
          {retirosNovos.length === 0 ? (
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {retirosNovos.map((nome, i) => (
                <span key={i} style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "#EFE8D6", border: "1px solid #DCD2B3", borderRadius: 20, padding: "4px 10px", fontSize: 12.5 }}>
                        ...
                        <td colSpan={9} style={{ background: "#FBF9F3", padding: "14px 16px" }} onClick={(e) => e.stopPropagation()}>
                          ...
                          {rets.length === 0 ? <EmptyState text="Nenhum retiro cadastrado para esta fazenda." /> : (
                            <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 16 }}>
                              {rets.map((r) => (
                                <span key={r.id} style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "#EFE8D6", border: "1px solid #DCD2B3", borderRadius: 20, padding: "4px 10px", fontSize: 12.5 }}>
                          ...
                          {safs.length === 0 ? <EmptyState text="Nenhuma safra cadastrada para esta fazenda." /> : (
                            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                              {safs.map((s) => (
                                <span key={s.id} style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "#EFE8D6", border: "1px solid #DCD2B3", borderRadius: 20, padding: "4px 10px", fontSize: 12.5 }}>
      ...
      {bloqueadoSemPreRequisitos === "fazenda" ? (
        ...
        <>
          <div style={{ ...cardStyle, marginBottom: 24 }}>
            ...
            {produtos.length === 0 && (
              <p style={{ fontSize: 12, color: "#B9541E", marginTop: -8, marginBottom: 14 }}>Nenhuma progesterona injetável cadastrada neste local de estoque.</p>
            )}
            {nomeDuplicado && (
      ...
      {!fazendaAtiva ? (
        ...
        <>
          <div style={{ display: "flex", background: "#EFE8D6", borderRadius: 8, padding: 3, gap: 2, marginBottom: 20, width: "fit-content" }}>
            <button onClick={() => setAbaInterna("d0")}
              style={{
                ...
                background: abaInterna === "d0" ? "#3B5D45" : "transparent", color: abaInterna === "d0" ? "#F5EFDD" : "#6B685E",
              }}>D0</button>
            <button onClick={() => setAbaInterna("ressinc")}
              style={{
                padding: "8px 16px", borderRadius: 6, border: "none", cursor: "pointer", fontSize: 13, fontWeight: 600,
                display: "inline-flex", alignItems: "center", gap: 6,
                background: abaInterna === "ressinc" ? "#3B5D45" : "transparent", color: abaInterna === "ressinc" ? "#F5EFDD" : "#6B685E",
              }}>
              Ressinc
              {sugestoesRessinc.length > 0 && (
                <span style={{ background: "#B9541E", color: "#FFF6E9", borderRadius: 20, fontSize: 10.5, fontWeight: 700, padding: "1.5px 6px" }}>{sugestoesRessinc.length}</span>
              )}
            </button>
          </div>
          ...
          <div style={{ ...cardStyle, marginBottom: 24 }}>
            ...
            {nomeDuplicado && (
              <p style={{ fontSize: 12, color: "#B9541E", marginTop: -8, marginBottom: 14 }}>
              ...
              {!sugestaoAberta ? (
                ...
                <div style={{ ...cardStyle, marginBottom: 24, border: "1.5px solid #E3B8A0" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <ImplantIcon size={16} color="#B9541E" />
                      ...
                      return (
                        <button key={b} onClick={() => toggleSelecao(b)}
                          style={{
                            ...
                            background: selecionado ? "#F7E4D6" : "#EEE8D8", opacity: selecionado ? 1 : 0.55,
                          }}>
                          {selecionado ? <CheckCircle2 size={13} color="#B9541E" /> : <Circle size={13} color="#9B9686" />}
                          <EarTag size="sm">{b}</EarTag>
                        </button>
                      );
                    })}
      ...
      {bloqueado === "fazenda" ? (
        ...
        <>
          {bloqueado === "lote" ? (
            ...
            {excedeQuantidade && (
              <p style={{ fontSize: 12.5, color: "#B9541E", marginTop: 12 }}>
      ...
      {!fazendaAtiva ? (
        ...
        <>
          ...
          <div style={{ ...cardStyle, marginBottom: 24 }}>
            ...
            <SeletorLocalEstoque local={localEstoque} setLocal={setLocalEstoque} />
            {semens.length === 0 && (
              <p style={{ fontSize: 12, color: "#B9541E", marginTop: -8, marginBottom: 14 }}>Nenhum sêmen cadastrado neste local de estoque.</p>
            )}
                ...
                <table>
                  ...
                  <tbody>
                    {registros.map((r) => (
                      <tr key={r.brinco}>
                        <td><EarTag size="sm">{r.brinco}</EarTag></td>
                        <td style={{ color: r.resultado === "Prenha" ? "#3B5D45" : "#B9541E", fontWeight: 600 }}>
                          {r.resultado}{r.resultado === "Vazia" && <span style={{ marginLeft: 8, fontSize: 11, fontWeight: 600, color: "#B9541E" }}>· gera sugestão de Ressinc</span>}
                        </td>
                        <td style={{ fontWeight: 700 }}>{lotes.find((l) => l.id === r.loteId)?.nome || "—"}</td>
                        <td>{r.observacao || "—"}</td>
                        <td><button onClick={() => remover(r.brinco)} style={{ background: "none", border: "none", cursor: "pointer", color: "#A32D2D" }}><Trash2 size={14} /></button></td>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 10, fontSize: 12.5, color: "#4A473E" }}>
                  ...
                  {consultaAtual.porOrdem.map((o, i) => (
                    <React.Fragment key={i}>
                      ...
                      <div><strong>DG {ORDENS_IATF[i]}:</strong> <span style={{ color: o.dg === "Prenha" ? "#3B5D45" : o.dg === "Vazia" ? "#B9541E" : "#6B685E", fontWeight: o.dg !== "—" ? 600 : 400 }}>{o.dg}</span></div>
                    </React.Fragment>
                  ))}
                  ...
                  {registros.map((r) => (
                    <tr key={r.brinco}>
                      ...
                      {r.porOrdem.map((o, i) => (
                        <React.Fragment key={i}>
                          <td>{o.data}</td>
                          <td style={{ color: o.dg === "Prenha" ? "#3B5D45" : o.dg === "Vazia" ? "#B9541E" : "#6B685E", fontWeight: o.dg !== "—" ? 600 : 400 }}>{o.dg}</td>
                        </React.Fragment>
                      ))}
                      <td style={{ color: r.dgFinal === "Prenha" ? "#3B5D45" : r.dgFinal === "Vazia" ? "#B9541E" : "#6B685E", fontWeight: r.dgFinal !== "—" ? 600 : 400 }}>{r.dgFinal}</td>
                      ...
                      <td style={{ fontWeight: r.origem !== "—" ? 600 : 400, color: r.origem === "Repasse" ? "#B9541E" : r.origem === "Inseminação" ? "#3B5D45" : "#6B685E" }}>{r.origem}</td>
                      <td><button onClick={() => remover(r.brinco)} style={{ background: "none", border: "none", cursor: "pointer", color: "#A32D2D" }}><Trash2 size={14} /></button></td>
                    </tr>
                  ))}
                </tbody>
    ...
    <div>
      ...
      {!fazendaAtiva ? (
        ...
        <>
          ...
          <div style={{ display: "flex", background: "#EFE8D6", borderRadius: 8, padding: 3, gap: 2, marginBottom: 18, width: "fit-content" }}>
...
function AbaAgenda({ fazendaAtiva, fazendas, lotes, retiros, agendamentos, addAgendamento, confirmarAgendamento, descartarAgendamento, removerAgendamento, atualizarAgendamento }) {
  ...
  const StatusBadge = ({ status }) => {
    const cfg = {
      pendente: { bg: "#F7E4D6", color: "#8A3E15", label: "Aguardando confirmação" },
